...
import PersonalReport from "./Products/PersonalReport";
import { useAuth } from "@/components/AuthContext";
import LoginPopup from "@/components/LoginPopup";

async function getDietPlanResults({ prompt, dietPlanName }) {
...
export default function DietTest({ setShowTest, dietPlan, onPurchase }) {
  ...
  useEffect(() => {
    if (currentIndex === dietPlan?.questions?.length) {
      setLoading(true);
  ...
  }, [currentIndex, dietPlan?.questions?.length, selected]);
      ...
      <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
        <div className="w-full max-w-2xl bg-white rounded-3xl flex flex-col overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white p-4 lg:p-8 text-center relative overflow-hidden flex-shrink-0">
            ...
            <h1 className="text-xl lg:text-3xl xl:text-4xl font-bold mb-4 pr-12">
              {dietPlan?.title}
            </h1>
          </div>
          ...
          <div className="flex flex-col p-6 lg:p-8">
            <div className="text-center mb-6">
              <h3 className="text-lg lg:text-2xl font-bold text-gray-800 mb-4">
                Brak testu dostępnego
              </h3>
              <p className="text-gray-600 mb-6">
                Ten plan dietetyczny nie ma jeszcze dostępnego testu. Możesz go
                kupić bezpośrednio.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-lg font-bold text-lg shadow-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 flex items-center space-x-2"
              >
                <FaShoppingCart />
                <span>Kup teraz</span>
              </button>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl h-[90vh] bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-3xl flex flex-col overflow-hidden">
        {/* Confetti Animation */}
        {shouldAnimate && (
          <div
        ...
        <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white p-4 lg:p-8 text-center relative overflow-hidden flex-shrink-0">
          ...
          <div className="relative z-10">
            {!results && (
              ...
              >
                Test przed zakupem: {dietPlan?.title}
              </motion.h1>
            )}
              ...
              <div className="flex flex-col items-center gap-3">
                <div className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-3 py-2 text-sm">
                  ...
                  <span className="font-medium">
                    Pytanie {currentIndex + 1} z {dietPlan?.questions?.length}
                  </span>
                </div>
            ...
            <div className="relative">
              ...
              {finished && !results && (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4 lg:mb-6 text-sm lg:text-base">
                    Dziękujemy za wypełnienie ankiety. Analizujemy Twoje
                    preferencje...
                  </p>
              ...
              {results && (
                <motion.div
                  ...
                  className="py-6"
                >
                  {/* PersonalReport Component */}
                  <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg mb-6">
                    <PersonalReport data={results} />
                  </div>

                  {/* Diet Plan Purchase Section */}
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-700 text-sm lg:text-base">
                        Na podstawie Twoich odpowiedzi przygotowaliśmy
                        spersonalizowany plan dietetyczny. Kup teraz, aby
                        otrzymać pełny dostęp do swojego planu!
                      </p>
                    </div>
