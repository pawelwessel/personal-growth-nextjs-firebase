...
import { StripePricingTable } from "@stripe/stripe-js";
...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <StripePricingTable
        pricingTableId="prctbl_1RkOxaIowW84f8F2ygReIx6N"
        publishableKey="pk_test_51RkOmdIowW84f8F2fVjR6PPlODJzwr9lg64Jtmg4Uh3hVlCwhXSDmbgXaqcoqPWG1XuzpokDuAJCmrgz7D6VhdTr00ES4Olhrb"
      />
      {/* Footer */}
