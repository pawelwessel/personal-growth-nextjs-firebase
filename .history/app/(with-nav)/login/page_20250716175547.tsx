...
export const metadata: Metadata = {
  title: "Logowanie - Zaloguj się do swojego konta | MocnyRozwój.pl",
  description:
    "Zaloguj się do swojego konta i uzyskaj dostęp do spersonalizowanych testów osobowości, raportów rozwojowych i narzędzi.",
  keywords:
    "logowanie, konto użytkownika, testy osobowości, raporty rozwojowe, dostęp",
  openGraph: {
    title: "Logowanie - Zaloguj się do swojego konta | MocnyRozwój.pl",
    description:
      "Zaloguj się do swojego konta i uzyskaj dostęp do spersonalizowanych testów osobowości i raportów.",
    type: "website",
    url: "https://mocnyrozwoj.pl/login",
    images: [
      {
        url: "/logo.png",
        width: 512,
        height: 512,
        alt: "Logowanie - Zaloguj się do swojego konta",
      },
    ],
  },
  twitter: {
    ...
    title: "Logowanie - Zaloguj się do swojego konta | MocnyRozwój.pl",
    description:
      "Zaloguj się do swojego konta i uzyskaj dostęp do spersonalizowanych testów osobowości.",
    images: ["/logo.png"],
  },
  robots: {
    index: true,
  ...
  alternates: {
    canonical: "https://mocnyrozwoj.pl/login",
  },
};
