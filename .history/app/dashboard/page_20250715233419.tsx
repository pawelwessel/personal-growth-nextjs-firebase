...
function DashboardContent() {
  ...
  // Refresh ownership data when component mounts or when coming from success page
  useEffect(() => {
    if (user) {
      ...
      console.log("Dashboard: Checking for payment success", {
        paymentSuccess,
        sessionId,
      });
      ...
      if (paymentSuccess === "true" || sessionId) {
        ...
        console.log("Payment success detected, refreshing ownership data...");
  ...
  }, [user, refreshAllOwnership, searchParams]);
