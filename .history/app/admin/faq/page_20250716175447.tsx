...
export const metadata: Metadata = {
  title: "Zarządzanie FAQ - Panel administracyjny | MocnyRozwój.pl",
  description:
    "Panel administracyjny do zarządzania treścią FAQ. Dodawaj, edytuj i usuwaj pytania oraz odpowiedzi.",
  robots: {
    index: false,
    follow: false,
  },
