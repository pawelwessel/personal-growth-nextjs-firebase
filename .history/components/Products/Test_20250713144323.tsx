...
export default function Test({
  ...
  return (
    <div className="overflow-hidden pb-6 flex text-center flex-col min-h-screen lg:min-h-auto lg:h-max bg-white w-full lg:w-[35rem] items-center mx-auto lg:rounded-xl shadow-sm shadow-gray-300 relative my-12">
      ...
      {!finished && (
        <div className="flex flex-col items-center gap-2 mb-3 mt-6">
          <p className="text-white bg-blue-500 px-3 py-1.5 rounded-full text-sm w-max block mx-auto">
          ...
          {test &&
            ...
            currentIndex < test.questions.length - 1 && (
              <p className="text-gray-500 text-xs">
                Naciśnij{" "}
                <span className="bg-gray-200 px-1 rounded font-mono">E</span>{" "}
