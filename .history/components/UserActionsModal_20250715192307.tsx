              ...
              <div className="p-6">
                <div className="grid grid-cols-3 gap-4">
                  {userActions.map((action) => (
                    ...
                    >
                      <div
                        className={`flex flex-col items-center space-y-2 ${action.color}`}
                      >
                        {action.icon}
                        ...
                        <AnimatePresence>
                          {hoveredAction === action.id && (
                            <motion.span
                              ...
                              exit={{ opacity: 0, y: 10 }}
                              className="absolute top-full mt-2 px-3 py-1 bg-gray-900 text-white text-xs rounded-lg whitespace-nowrap z-60"
                            >
                              {action.text}
                              {/* Arrow */}
